...
RModal.prototype.close = function close (action) {
        var this$1 = this;

    if (!is(this.opts.beforeClose, 'function')) {
        return this._doClose(action);
    }

    this.opts.beforeClose(function () {
        this$1._doClose(action);
    });
};
...
RModal.prototype._doClose = function _doClose (action) {
        var this$1 = this;
