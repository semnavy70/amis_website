...
Route::get('/home/monthly-export/{dataseriescode}/{cultureid}', [\Vanguard\Http\Controllers\Web\Front\HomeController::class, 'monthlyExport'])->name('home.monthly-export');
