<?php $__env->startSection('page-title', __('Slide')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-6">
            <form class="form-inline" method="GET" action="<?php echo e(route("slide.index")); ?>">
        ...
        <div class="col-6 d-flex justify-content-end">
            <a role="button" class="btn btn-primary" href="<?php echo e(route('slide.create')); ?>"><i
    ...
    <table class="table table-hover category-table">
        ...
        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-sm btn-primary" href="<?php echo e(route("slide.edit",["id"=>$item->id])); ?>">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="<?php echo e(route('slide.delete', ["id"=>$item->id])); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/semnavy/Desktop/Data/Amis/SourceCode/amis_website/resources/views/slide/index.blade.php ENDPATH**/ ?>