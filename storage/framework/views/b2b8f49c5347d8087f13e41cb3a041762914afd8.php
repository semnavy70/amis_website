<?php $__env->startSection('page-title', __('Advertise blog')); ?>
<?php $__env->startSection('page-heading', __('Manage advertise')); ?>

<?php $__env->startSection('breadcrumbs'); ?>
    <li class="breadcrumb-item active">
        <?php echo app('translator')->get('Advertise blog'); ?>
    </li>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-6">
            <form class="form-inline" action="<?php echo e(route('advertise-blog.index')); ?>" method="GET">
        ...
        <div class="col-6 d-flex justify-content-end">
            <a role="button" class="btn btn-primary" href="<?php echo e(route('advertise-blog.create')); ?>"><i
                    class="fas fa-plus mr-1"></i><?php echo app('translator')->get('Create new'); ?></a>
        </div>
    </div>
    <table class="table table-hover advertise-blog-table">
        ...
        <tr>
            ...
            <th scope="col"><?php echo app('translator')->get('Total advertise'); ?></th>
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td>
                    <a class="btn btn-sm btn-primary" href="<?php echo e(route("advertise-blog.edit",["id"=>$item->id])); ?>">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="<?php echo e(route('advertise-blog.delete', ["id"=>$item->id])); ?>"
                       class="btn btn-sm btn-danger ml-1 <?php echo e($item->count_advertise > 0 ? 'disabled' : ''); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/semnavy/Desktop/Data/Amis/SourceCode/amis_website/resources/views/advertise/blog/index.blade.php ENDPATH**/ ?>