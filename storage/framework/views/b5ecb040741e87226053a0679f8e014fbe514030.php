<?php $__env->startSection('page-title', __('Menus')); ?>
<?php $__env->startSection('page-heading', __('Manage Menus')); ?>

<?php $__env->startSection('breadcrumbs'); ?>
    <li class="breadcrumb-item active">
        <?php echo app('translator')->get('Menus'); ?>
    </li>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-6">
            <form class="form-inline" action="<?php echo e(route('menuitem.index')); ?>" method="GET">
        ...
        <div class="col-6 d-flex justify-content-end">
            <a role="button" class="btn btn-primary ml-3" href="<?php echo e(route('menuitem.create')); ?>"><i
    ...
    <table class="table table-hover post-table">
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td>
                    <a href="<?php echo e(route('menuitem.edit' , ['id' => $item->id])); ?>" class="btn btn-sm btn-primary"
                    ...
                    <a class="btn btn-sm btn-danger ml-1"
                       title="<?php echo app('translator')->get('លុបមុឺនុយ'); ?>"
                       href="<?php echo e(route('menuitem.delete', ['id' => $item->id])); ?>"
                       data-toggle="tooltip"
                       data-placement="top"
                       data-method="DELETE"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/semnavy/Desktop/Data/Amis/SourceCode/amis_website/resources/views/menuitem/index.blade.php ENDPATH**/ ?>