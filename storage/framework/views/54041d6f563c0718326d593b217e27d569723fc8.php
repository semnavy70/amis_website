<?php $__env->startSection('page-title', __('Post blog')); ?>
<?php $__env->startSection('page-heading', __('Manage post')); ?>

<?php $__env->startSection('breadcrumbs'); ?>
    <li class="breadcrumb-item active">
        <?php echo app('translator')->get('Post blog'); ?>
    </li>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-6">
            <form class="form-inline" action="<?php echo e(route('post-blog.index')); ?>" method="GET">
        ...
        <div class="col-6 d-flex justify-content-end">
            <a role="button" class="btn btn-primary" href="<?php echo e(route('post-blog.create')); ?>"><i
    ...
    <table class="table table-hover blog-table">
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td>
                    <a href="<?php echo e(route('post-blog.edit', ['id' => $item->id])); ?>" class="btn btn-sm btn-primary">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="<?php echo e(route('post-blog.delete', ["id"=>$item->id])); ?>"
                       class="btn btn-sm btn-danger ml-1 <?php echo e($item->count_post > 0 ? 'disabled' : ''); ?>"
                       title="<?php echo app('translator')->get('លុបប្លុក'); ?>"
                       data-toggle="tooltip"
                       data-placement="top"
                       data-method="DELETE"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/semnavy/Desktop/Data/Amis/SourceCode/amis_website/resources/views/post/blog/index.blade.php ENDPATH**/ ?>