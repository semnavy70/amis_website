<?php $__env->startSection('document-title', __('Document category')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-6">
            <form class="form-inline" method="GET" action="<?php echo e(route("document-category.index")); ?>">
        ...
        <div class="col-6 d-flex justify-content-end">
            <a role="button" class="btn btn-primary" href="<?php echo e(route('document-category.create')); ?>"><i
    ...
    <table class="table table-hover category-table">
        ...
        <tr>
            ...
            <th scope="col"><?php echo app('translator')->get('Total Documents'); ?></th>
        ...
        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td><?php echo e($item->count_document); ?></td>
                <td>
                    <a class="btn btn-sm btn-primary" href="<?php echo e(route("document-category.edit",["id"=>$item->id])); ?>">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="<?php echo e(route('document-category.delete', ["id"=>$item->id])); ?>"
                       class="btn btn-sm btn-danger ml-1 <?php echo e($item->count_document > 0 ? 'disabled' : ''); ?>"
                       title="<?php echo app('translator')->get('លុបប្រភេទ'); ?>"
                       data-toggle="tooltip"
                       data-placement="top"
                       data-method="DELETE"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/semnavy/Desktop/Data/Amis/SourceCode/amis_website/resources/views/document/category/index.blade.php ENDPATH**/ ?>