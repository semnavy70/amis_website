...
<?php $__env->startSection('site-title','Home - Agricultural Market Information Service'); ?>
<style>
    ...
    <div class="content position-relative">
        <div class="container">
            <div class="block-home">
                <div class="row">
                    <div class="col-6 col-sm-6 col-md-3">
                        <div class="box-item">
                            <a href="<?php echo e(app_url('topic/news-and-events')); ?>" class="box orange">
                                <img src="<?php echo e(url('assets/img/news.png')); ?>" alt="">
                            </a>
                            <h5>
                                <?php echo app('translator')->getFromJson('translator.news_and_events'); ?>
                            </h5>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3">
                        <div class="box-item">
                            <a href="<?php echo e(app_url('market')); ?>" class="box green">
                                <img src="<?php echo e(url('assets/img/online-market.png')); ?>" alt="">
                            </a>
                            <h5>
                                <?php echo app('translator')->getFromJson('translator.online_market'); ?>
                            </h5>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3">
                        <div class="box-item">
                            ...
                            <a href="<?php echo e(app_url('bussiness')); ?>" class="box red">
                                <img src="<?php echo e(url('assets/img/information.png')); ?>" alt="">
                            </a>
                            <h5>
                                <?php echo app('translator')->getFromJson('translator.sms_service'); ?>
                            </h5>
                        </div>
                    </div>
                    <div class="col-6 col-sm-6 col-md-3">
                        <div class="box-item">
                            <a href="<?php echo e(app_url('document/monthly-price-bulletin')); ?>" class="box brand">
                                <img src="<?php echo e(url('assets/img/record.png')); ?>" alt="">
                            </a>
                            <h5>
                                <?php echo app('translator')->getFromJson('translator.information'); ?>
                            </h5>
                        </div>
                    </div>
                </div>
            ...
            <section class="welcome">
                <h3><?php echo app('translator')->getFromJson('translator.welcome'); ?>
                    <span style="color: #707A1A"><?php echo app('translator')->getFromJson('translator.amis_website'); ?></span>
                </h3>
                <span class="b-line"></span>
                <p><?php echo app('translator')->getFromJson('translator.description'); ?></p>
            </section>
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-7 pl-0 pr-3">
                        <div class="shadow-sm p-3 bg-white rounded main-info-min-height">
                            <?php $item = $monthly->translate(App::getLocale()); ?>
                            <h4 class="text-center mb-3 main-title"><?php echo e($item->title); ?></h4>
                            ...
                            <div class="row">
                                <div class="col-lg-7 col-md-12 col-sm-12 order-lg-2">
                                    <div class="monthly-content">
                                        ...
                                        <a href="<?php echo e(getLink($item)); ?>" class="float-right pt-3 pr-2"><?php echo app('translator')->getFromJson('translator.read_more'); ?>
                                            <span>
                                ...
                                <div class="col-lg-5 col-md-12 col-sm-12 order-lg-1">
                                    <div class="box-img">
                                        <img src="<?php echo e(gcpUrl($item->image)); ?>" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-5 pl-0 pr-0 ">
                        <div class="shadow-sm p-3 bg-white rounded main-info-min-height">
                            <?php $item = $production->translate(App::getLocale()); ?>
                            <h4 class="text-center mb-3 main-title"> <?php echo app('translator')->getFromJson('translator.production_and_production_export'); ?></h4>
                            <span class="b-line mb-3"></span>
                            <div class="row">
                                <div class="col-12">
                                    <div class="monthly-content">
                                        ...
                                        <div class="row mb-2 pt-4">
                                            <div class="col-6">
                                                <a href="<?php echo e(route('voyager.products.map')); ?>" class="float-left pt-3 mt-3 pr-2"><?php echo app('translator')->getFromJson('translator.production'); ?>
                                                </a>
                                            </div>
                                            <div class="col-6">
                                                <a href="<?php echo e(route('voyager.productexport.index')); ?>" class="float-right pt-3 mt-3 pr-2"><?php echo app('translator')->getFromJson('translator.productionexport'); ?>
                                                </a>
                                            </div>
                                        </div>
            ...
            <section class="tables">
                <div class="title">
                    <h3 class="text-center"><?php echo app('translator')->getFromJson('translator.recent_price'); ?></h3>
                    <span class="b-line mb-3"></span>

                </div>
                <?php if(App::getLocale()=='kh'): ?>
                    
                    <a href="<?php echo e(app_url('export')); ?>">ទាញយក <span class="fa fa-file-excel"></span></a>
                <?php elseif(App::getLocale()=='en'): ?>
                    <a href="<?php echo e(app_url('export')); ?>">Export <span class="fa fa-file-excel"></span></a>

                <?php endif; ?>
                <!-- <div class="row"> -->
                
                 <div id="LatestProductContainer" style="width: 100%;" data-url="https://tmp.camagrimarket.org/api/website/report/latest_product" data-locale="<?php echo e(App::getLocale()=='kh'?2:1); ?>"></div>
                   
                <!-- </div> -->
            </section>

            <section class="chart mw-100">
                <h3 class="text-center"><?php echo app('translator')->getFromJson('translator.price_fluc'); ?></h3>
                    ...
                    <div class="row" style="margin-bottom: 10px;border: 1px solid #eee;padding: 25px;background-color: #fff; margin-left: 0px; margin-right: 0px;">
                        <div class="col-3 col-md-3">
                            <div class="form-group">
                                <label for="category"><?php echo app('translator')->getFromJson('translator.category'); ?></label>
                                <?php if(App::getLocale()=='kh'): ?>
                                    <select class="form-control" name="category" id="Category" data-url="<?php echo e(url('api/marketapp/commodities-categories')); ?>" data-locale="2"></select>
                                <?php elseif(App::getLocale()=='en'): ?>
                                    <select class="form-control" name="category" id="Category" data-url="<?php echo e(url('api/marketapp/commodities-categories')); ?>" data-locale="1"></select>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-3 col-md-3">
                            <div class="form-group">
                                <label for="commodity"><?php echo app('translator')->getFromJson('translator.commodity'); ?></label>
                                <?php if(App::getLocale()=='kh'): ?>
                                    <select class="form-control" name="commodity" id="Commodity" data-url="<?php echo e(url('api/marketapp/category-commodities')); ?>" data-locale="2"></select>
                                <?php elseif(App::getLocale()=='en'): ?>
                                    <select class="form-control" name="commodity" id="Commodity" data-url="<?php echo e(url('api/marketapp/category-commodities')); ?>" data-locale="1"></select>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-3 col-md-3">
                            <div class="form-group">
                                <label for="commodity1"><?php echo app('translator')->getFromJson('translator.commodity2'); ?></label>
                                <?php if(App::getLocale()=='kh'): ?>
                                    <select class="form-control" name="commodity1" id="Commodity1" data-url="<?php echo e(url('api/marketapp/category-commodities')); ?>" data-locale="2"></select>
                                <?php elseif(App::getLocale()=='en'): ?>
                                    <select class="form-control" name="commodity1" id="Commodity1" data-url="<?php echo e(url('api/marketapp/category-commodities')); ?>" data-locale="1"></select>
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-3 col-md-3">
                            <div class="form-group">
                                <label for="commodity2"><?php echo app('translator')->getFromJson('translator.commodity3'); ?></label>
                                <?php if(App::getLocale()=='kh'): ?>
                                    <select class="form-control" name="commodity2" id="Commodity2" data-url="<?php echo e(url('api/marketapp/category-commodities')); ?>" data-locale="2"></select>
                                <?php elseif(App::getLocale()=='en'): ?>
                                    <select class="form-control" name="commodity2" id="Commodity2" data-url="<?php echo e(url('api/marketapp/category-commodities')); ?>" data-locale="1"></select>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-5 col-md-2">
                        <div class="form-check">
                            <?php if(App::getLocale()=='kh'): ?>
                                ...
                                <label class="form-check-label"><?php echo app('translator')->getFromJson('translator.wholesale'); ?></label>
                            <?php elseif(App::getLocale()=='en'): ?>
                                <input type="checkbox" class="form-check-input" checked name="dataseries1" value="WP">
                                <label class="form-check-label"><?php echo app('translator')->getFromJson('translator.wholesale'); ?></label>
                            <?php endif; ?>
                    ...
                    <div class="col-5 col-md-2">
                        <div class="form-check">
                            <?php if(App::getLocale()=='kh'): ?>
                                ...
                                <label class="form-check-label"><?php echo app('translator')->getFromJson('translator.retail'); ?></label>
                            <?php elseif(App::getLocale()=='en'): ?>
                                <input type="checkbox" class="form-check-input" name="dataseries1" value="RP" >
                                <label class="form-check-label"><?php echo app('translator')->getFromJson('translator.retail'); ?></label>
                            <?php endif; ?>
            ...
            <section class="tables">
                <div class="title">
                    <h3 class="text-center"><?php echo app('translator')->getFromJson('translator.price_monthly'); ?>
                        <?php if(App::getLocale()=='kh'): ?>
                            <?php echo e($month); ?>

                        <?php elseif(App::getLocale()=='en'): ?>
                            of <?php echo e($monthEN); ?>
            ...
            <section class="last-news">
                <h3 class="text-center"><?php echo app('translator')->getFromJson('translator.latest'); ?></h3>
                <div class="b-line"></div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-img position-relative">
                                    <?php if($item->image == ""): ?>
                                    <img class="card-img-top rounded-0" src="<?php echo e(url('assets/img/no-photo.png')); ?>" class="img-fluid" alt="">
                                    <?php else: ?>
                                    <img class="card-img-top rounded-0" src="<?php echo e(gcpUrl($item->image)); ?>" class="img-fluid" alt="">
            ...
            <section class="sponsor">
                <h3 class="text-center"><?php echo app('translator')->getFromJson('translator.partners'); ?></h3>
                <div class="b-line"></div>
                
                <div class="content-news">
                    <div class="row">
                        <div class="col-6 col-md-2">
                            <img src="<?php echo e(url('assets/img/agri2.png')); ?>" height="60" />
                        </div>
                        <div class="col-6 col-md-3">
                            <img src="<?php echo e(url('assets/img/EU.png')); ?>" height="60" />
                        </div>
                        <div class="col-12 col-md-2">
                            <img src="<?php echo e(url('assets/img/wfp.png')); ?>" height="60" />                            
                        </div>
                        <div class="col-12 col-md-4">
                            <img src="<?php echo e(url('assets/img/PlusGate_Cellcard.png')); ?>" height="60" />
                        </div>                        
                    </div>
                </div>
            </section>
...
<input type="hidden" id="wsale" value="<?php echo app('translator')->getFromJson('translator.wholesale'); ?>"/>
<input type="hidden" id="rprice" value="<?php echo app('translator')->getFromJson('translator.retail'); ?>"/>
<input type="hidden" id="price" value="<?php echo app('translator')->getFromJson('translator.price_riel'); ?>"/>
<?php echo e(Counter::count('/')); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('chart-js'); ?>

    <script src="<?php echo e(url('assets/js/highcharts.js')); ?>"></script>
    <script src="https://code.highcharts.com/modules/boost.js"></script>
    <script src="<?php echo e(url('assets/js/exporting.js')); ?>?v=3"></script>
    <script src="<?php echo e(url('assets/js/prices-fluctuation.js?v=7')); ?>"></script>
        ...
        function getdata(url){
            ...
            $.ajax({url: url, success: function(result){
                ...
                if(result.length==0){
                    ...
                    var s_head = "<thead><tr>";
                    var th1 = "<th style='min-width: 100px;text-align: left;padding: .4rem;color: #ffffff;background-color: #707a1b;'><?php echo app('translator')->getFromJson('translator.province'); ?></th>";
                    var th2 = "<th style='min-width: 100px;text-align: left;padding: .4rem 0;color: #ffffff;background-color: #707a1b;'><?php echo app('translator')->getFromJson('translator.market'); ?></th>";
                    var other_th = "";
                    ...
                    result.forEach(element => {
                            ...
                            var label = '<?php echo e(App::getLocale()=="kh" ? "name_kh":"name_en"); ?>';
                            var tr = "<tr>";
