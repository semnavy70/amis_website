<?php $__env->startSection('page-title', __('Create Partner')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form action="<?php echo e(route("partner.store")); ?>" method="POST" id="partner-form" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php $__env->startSection('scripts'); ?>
    <?php echo JsValidator::formRequest('Vanguard\Http\Requests\Partner\CreatePartnerRequest','#partner-form'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/semnavy/Desktop/Data/Amis/SourceCode/amis_website/resources/views/partner/create.blade.php ENDPATH**/ ?>