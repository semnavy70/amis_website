            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <textarea class="form-control richTextBox-kravanh" id="richtextbody" name="body" style="border:0px;">@if(isset($dataTypeContent->body)){{ $dataTypeContent->body }}@endif</textarea>
                    </div><!-- .panel -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="panel panel-bordered panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <!--<input type="hidden" name="image" class="post-image"/>
                            <a href="javascript:void(0)" class="kravanh-media-modal" target-input=".post-image">Choose</a>-->
                        </div>
                    </div>
