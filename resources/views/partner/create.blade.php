...
@section('page-title', __('Create Partner'))
...
@section('content')
    ...
    <form action="{{route("partner.store")}}" method="POST" id="partner-form" enctype="multipart/form-data">
        @csrf
...
@section('scripts')
    {!! JsValidator::formRequest('Vanguard\Http\Requests\Partner\CreatePartnerRequest','#partner-form') !!}
    <script>
