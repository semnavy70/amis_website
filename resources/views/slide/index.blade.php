...
@section('content')
    ...
    <div class="row">
        <div class="col-6">
            <form class="form-inline" method="GET" action="{{route("slide.index")}}">
        ...
        <div class="col-6 d-flex justify-content-end">
            <a role="button" class="btn btn-primary" href="{{ route('slide.create') }}"><i
    ...
    <table class="table table-hover category-table">
        ...
        @foreach($data as $item)
            <tr>
                ...
                <td>{{ $item->order??"" }}</td>
                <td>
                    <a class="btn btn-sm btn-primary" href="{{ route("slide.edit",["id"=>$item->id]) }}">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="{{ route('slide.delete', ["id"=>$item->id]) }}"
