...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{ url('coming/fonts/iconic/css/material-design-iconic-font.min.css') }}">
<!--===============================================================================================-->
...
<body>
	...
	<div class="simpleslide100">
		<div class="simpleslide100-item bg-img1" style="background-image: url('coming/images/bg01.jpg');"></div>
		<div class="simpleslide100-item bg-img1" style="background-image: url('coming/images/bg02.jpg');"></div>
		<div class="simpleslide100-item bg-img1" style="background-image: url('coming/images/bg03.jpg');"></div>
		<div class="simpleslide100-item bg-img1" style="background-image: url('coming/images/bg04.jpg');"></div>
	</div>
	...
	<div class="flex-col-c-sb size1 overlay1 p-l-75 p-r-75 p-t-20 p-b-40 p-lr-15-sm">
		...
		<div class="w-full flex-w flex-sb-m">
			<div class="wrappic1 m-r-30 m-t-10 m-b-10">
				<a href="/"><img src="{{ url('assets/img/logo.png') }}" alt="LOGO"></a>
			</div>
