...
@section('page-title', __('Advertise blog'))
...
@section('content')
    ...
    <div class="row">
        <div class="col-6">
            <form class="form-inline" action="{{ route('advertise-blog.index') }}" method="GET">
        ...
        <div class="col-6 d-flex justify-content-end">
            <a role="button" class="btn btn-primary" href="{{ route('advertise-blog.create') }}"><i
    ...
    <table class="table table-hover advertise-blog-table">
        ...
        @foreach($list as $item)
            <tr>
                ...
                <td>
                    <a class="btn btn-sm btn-primary" href="{{ route("advertise-blog.edit",["id"=>$item->id]) }}">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="{{ route('advertise-blog.delete', ["id"=>$item->id]) }}"
