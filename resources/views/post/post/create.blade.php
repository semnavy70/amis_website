        ...
        <form action="{{ route('post.store') }}" method="POST" id="post-form" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <div class="form-group">
                        <label for="status">@lang('Is Popular')</label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="is_popular" id="is_popular" value="1">
                            <label class="form-check-label" for="is_popular">
                                បង្ហាញ
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="is_popular" id="is_popular" value="0" checked="checked">
                            <label class="form-check-label" for="is_popular">
                                មិនបង្ហាញ
                            </label>
                        </div>
                    ...
                    <div class="form-group text-center mt-4 d-none">
                        <img id="image_mobile_preview" class="image_preview" src="#" alt="image_mobile" width="300">
                    </div>
                    <div class="form-group text-center mt-4 d-none">
                        <img id="image_pin_news_preview" class="image_preview" src="#" alt="image_pin_news" width="300">
                    </div>
