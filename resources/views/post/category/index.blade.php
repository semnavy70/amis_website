...
@section('page-title', __('Post category'))
...
@section('content')
    ...
    <div class="row">
        <div class="col-6">
            <form class="form-inline" method="GET" action="{{route("post-category.index")}}">
        ...
        <div class="col-6 d-flex justify-content-end">
            <a role="button" class="btn btn-primary" href="{{ route('post-category.create') }}"><i
    ...
    <table class="table table-hover category-table">
        ...
        @foreach($list as $item)
            <tr>
                ...
                <td>
                    <a class="btn btn-sm btn-primary" href="{{ route("post-category.edit",["id"=>$item->id]) }}">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="{{ route('post-category.delete', ["id"=>$item->id]) }}"
