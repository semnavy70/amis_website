...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-6 d-flex justify-content-end">
            <a role="button" class="btn btn-primary ml-3" href="{{ route('menus.create') }}"><i
    ...
    <table class="table table-hover post-table">
        ...
        @foreach ($list as $item)
            <tr>
                ...
                <td>{{ $item->name }}</td>
                <td>
                    <a href="{{ route('menus.edit' , ['id' => $item->id]) }}" class="btn btn-sm btn-primary"
                       title="@lang('Edit')"
                       data-toggle="tooltip"
                    >
                    ...
                    <a class="btn btn-sm btn-danger ml-1"
                       ...
                       href="{{ route('menus.delete', ['id' => $item->id]) }}"
                       data-toggle="tooltip"
                       data-placement="top"
                       data-method="DELETE"
